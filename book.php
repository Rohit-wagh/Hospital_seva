                 ...
                 <form action=" " method="post" role="form" class="php-email-form">
						<div class="form-group">
							...
							<b>	<span class="form-label">Full Name</span></b>
										...
										<input class="form-control" type="search" name="name" placeholder="Enter first and last name" 
										label="[object Object]" id="name" maxlength="900"  required>


									</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<b>	<div><span class="form-label">Email Address</span></b>
										<input class="form-control" type="email" name="email" placeholder="name@gmail.com" maxlength="900" required>
									</div>
					</div>
						...
						<input id="phone" name="mobno" type="text">
</div> &nbsp;&nbsp;&nbsp;&nbsp;
<!------------------------button------------------------>
...
<?php
     if(isset($_POST['booked']))
	 {
	   ...
	   $email=$_POST['email'];
	   $mobno=$_POST['mobno'];
	   $insert = "insert into book(name,email,mobno,datetime) values('$name','$email','$mobno',NOW())";
